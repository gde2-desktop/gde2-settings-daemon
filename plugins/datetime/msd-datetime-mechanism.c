           ...
           DBusGMethodInvocation *context)
{
        ...
        if (!_check_polkit_for_action (mechanism, context, "org.gde2.settingsdaemon.datetimemechanism.settime"))
                return FALSE;
                                     ...
                                     DBusGMethodInvocation *context)
{
        ...
        if (!_check_polkit_for_action (mechanism, context, "org.gde2.settingsdaemon.datetimemechanism.settimezone"))
                return FALSE;
                                                     ...
                                                     DBusGMethodInvocation *context)
{
        ...
        if (!_check_polkit_for_action (mechanism, context,
                                       "org.gde2.settingsdaemon.datetimemechanism.configurehwclock"))
                return FALSE;
                                     ...
                                     DBusGMethodInvocation *context)
{
        check_can_do (mechanism,
                      "org.gde2.settingsdaemon.datetimemechanism.settime",
                      context);
...
{
        check_can_do (mechanism,
                      "org.gde2.settingsdaemon.datetimemechanism.settimezone",
                      context);
