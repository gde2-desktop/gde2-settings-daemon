...
#define GDE2_SOUND_SCHEMA "org.gde2.sound"
...
flush_cache (void)
{
        ...
        pa_proplist_sets (pl, PA_PROP_APPLICATION_ID, "org.gde2.SettingsDaemon");
                         ...
                         GError **error)
{
        ...
        manager->priv->settings = g_settings_new (GDE2_SOUND_SCHEMA);
