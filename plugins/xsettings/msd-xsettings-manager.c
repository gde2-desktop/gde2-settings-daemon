...
#define GDE2_XSETTINGS_MANAGER_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), GDE2_TYPE_XSETTINGS_MANAGER, Gde2XSettingsManagerPrivate))

#define MOUSE_SCHEMA          "org.gde2.peripherals-mouse"
#define INTERFACE_SCHEMA      "org.gde2.interface"
#define SOUND_SCHEMA          "org.gde2.sound"

#define CURSOR_THEME_KEY      "cursor-theme"
#define CURSOR_SIZE_KEY       "cursor-size"

#define FONT_RENDER_SCHEMA    "org.gde2.font-rendering"
...
typedef void (* TranslationFunc) (Gde2XSettingsManager  *manager,
...
struct Gde2XSettingsManagerPrivate
{
...
static void     gde2_xsettings_manager_class_init  (Gde2XSettingsManagerClass *klass);
static void     gde2_xsettings_manager_init        (Gde2XSettingsManager      *xsettings_manager);
static void     gde2_xsettings_manager_finalize    (GObject                  *object);

G_DEFINE_TYPE (Gde2XSettingsManager, gde2_xsettings_manager, G_TYPE_OBJECT)
...
static void
translate_bool_int (Gde2XSettingsManager  *manager,
                    TranslationEntry      *trans,
                    GVariant              *value)
{
        int i;
...
static void
translate_int_int (Gde2XSettingsManager  *manager,
                   TranslationEntry      *trans,
                   GVariant              *value)
{
        int i;
...
static void
translate_string_string (Gde2XSettingsManager  *manager,
                         TranslationEntry      *trans,
                         GVariant              *value)
{
        int i;
...
static void
translate_string_string_toolbar (Gde2XSettingsManager  *manager,
                                 TranslationEntry      *trans,
                                 GVariant              *value)
{
        int         i;
 ...
 */
static void
xft_settings_get (Gde2XSettingsManager *manager,
                  Gde2XftSettings *settings)
{
...
static void
xft_settings_set_xsettings (Gde2XSettingsManager *manager,
                            Gde2XftSettings      *settings)
{
        int i;
...
static void
xft_settings_set_xresources (Gde2XftSettings *settings)
{
        GString    *add_string;
 ...
 */
static void
update_xft_settings (Gde2XSettingsManager *manager)
{
        Gde2XftSettings settings;
...
static gboolean
start_fontconfig_monitor_idle_cb (Gde2XSettingsManager *manager)
{
        gde2_settings_profile_start (NULL);
...
static void
start_fontconfig_monitor (Gde2XSettingsManager  *manager)
{
        gde2_settings_profile_start (NULL);
...
static void
stop_fontconfig_monitor (Gde2XSettingsManager  *manager)
{
...
static void
process_value (Gde2XSettingsManager *manager,
               TranslationEntry     *trans,
               GVariant             *value)
{
...
static gboolean
setup_xsettings_managers (Gde2XSettingsManager *manager)
{
        GdkDisplay *display;
        int         i;
        int         n_screens;
...
gboolean
gde2_xsettings_manager_start (Gde2XSettingsManager *manager,
                               GError               **error)
{
        guint        i;
        GList       *list, *l;
...
void
gde2_xsettings_manager_stop (Gde2XSettingsManager *manager)
{
        Gde2XSettingsManagerPrivate *p = manager->priv;
        int i;
...
static void
gde2_xsettings_manager_class_init (Gde2XSettingsManagerClass *klass)
{
        GObjectClass *object_class = G_OBJECT_CLASS (klass);

        object_class->finalize = gde2_xsettings_manager_finalize;

        g_type_class_add_private (klass, sizeof (Gde2XSettingsManagerPrivate));
}

static void
gde2_xsettings_manager_init (Gde2XSettingsManager *manager)
{
        manager->priv = GDE2_XSETTINGS_MANAGER_GET_PRIVATE (manager);
}

static void
gde2_xsettings_manager_finalize (GObject *object)
{
        Gde2XSettingsManager *xsettings_manager;

        g_return_if_fail (object != NULL);
        g_return_if_fail (GDE2_IS_XSETTINGS_MANAGER (object));

        xsettings_manager = GDE2_XSETTINGS_MANAGER (object);

        g_return_if_fail (xsettings_manager->priv != NULL);

        G_OBJECT_CLASS (gde2_xsettings_manager_parent_class)->finalize (object);
}

Gde2XSettingsManager *
gde2_xsettings_manager_new (void)
{
        if (manager_object != NULL) {
                g_object_ref (manager_object);
        } else {
                manager_object = g_object_new (GDE2_TYPE_XSETTINGS_MANAGER, NULL);
                g_object_add_weak_pointer (manager_object,
                                           (gpointer *) &manager_object);
        }

        return GDE2_XSETTINGS_MANAGER (manager_object);
}
